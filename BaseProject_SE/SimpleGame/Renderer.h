...
class Renderer
{
  public:
    ...
    void SurfaceTriangle(
        Point a, Point b, Point c, Point ua, Point ub, Point uc, Material material, Color color);
    void SurfaceQuad(Point a,
        Point b,
        Point c,
        Point d,
        Point ua,
